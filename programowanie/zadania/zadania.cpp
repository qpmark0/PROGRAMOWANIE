...
int main() {
    ...
    cout << "Elements of sumator in range 6-9" << endl;
    ...
    // ex3
    Person author1("Sara", "Dor", 49);
    Person author2("Jane", "Some", 26);

    Book book1("C++ Programming", author1, 2016);
    Book book2("Advanced C++", author2, 2008);
