...
- SUV (SUV), Pickup Truck (Pick-up), Truck (Ciê¿arówka), Car (Samochód),
Sedan (Sedan), Motorcycle (Motocykl),Vehicle (Pojazd), Semi-Truck (Ci¹gnik siod³owy)
- Smartphone (Smartfon), Android Phone (Telefon z systemem Android), Electronic Device
(Urz¹dzenie elektroniczne), LED TV (Telewizor LED), Laptop (Laptop), iPhone (iPhone), Television (Telewizor), Smart TV (Telewizor Smart)
*/
void task2() {
